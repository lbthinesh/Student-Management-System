...
def connect_database():
    ...
    connectWindow.geometry('470x250+540+250')
...
root.geometry('1530x790-1+0')
root.resizable(1,1)
root.title('Amrita Student Management System')

datetimeLabel=Label(root,font=('times new roman',18,'bold'))
datetimeLabel.place(x=5,y=5)
clock()
s='AMRITA STUDENT MANAGEMENT SYSTEM' #s[count]=t when count is 1
sliderLabel=Label(root,font=('agency fb',35,'bold'),width=50)
sliderLabel.place(x=350,y=0)
slider()

connectButton=ttk.Button(root,text='Connect database',command=connect_database)
connectButton.place(x=1300,y=24)

leftFrame=Frame(root)
leftFrame.place(x=50,y=80,width=600,height=700)
...
rightFrame.place(x=350,y=80,width=1130,height=700)
